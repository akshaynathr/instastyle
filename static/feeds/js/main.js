...
for(var i=0;i<data['feed'].length;i++)
  {
	...
	create(user_image,img_url,title,name,id,desc);
	//alert(desc);
...
function create(user_image,img_url,title,name,id,desc)
	 ...
	 $('.container').append(
		...
		'<div class="row" >'+
			...
			'<div class="col-md-6" style="background-color:rgb(248,248,248);border-radius:10px;margin-top:10px;"> ' +
							'<hr/>'+
				'<div style="margin-bottom:10px;"><img src=static/uploads/"'+user_image+'" style="width:30px; height:30px; border-radius:100%"><b> '+name+'</b><p style="float:right; font-size:10px; padding-top:10px;"> 23 hours ago</p> </div>'+
				...
				'<img  src="static/love.jpg" style="display:inline;width:40px; height:40px; border-radius:100%; ">  <p style="display:inline"> 144</p>'+ 
